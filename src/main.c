...
int main(void)
{
    ...
    STATE mode = VIEW;
    STATE_FUNCTION mode_functions[] = {&VIEW_FUNCTION, &AXIS_SELECT_FUNCTION, &GRID_SELECT_FUNCTION, &POINT_SELECT_FUNCTION, &TRANSLATE_TRANSITION_FUNCTION, &POINT_TRANSLATE_FUNCTION};
